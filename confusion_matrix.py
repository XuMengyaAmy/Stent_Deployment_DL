...
'''
y_true = np.loadtxt('/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D5/re_label_epoch30.txt')
y_pred = np.loadtxt('/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D5/pre_label_epoch30.txt')
...
plt.savefig('/media/mmlab/dataset/mengya/StentDetectionDataset//Dataset/D5/confusion_matrix_epoch30.png', format='png')
plt.show()