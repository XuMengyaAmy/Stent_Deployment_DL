...
def semilogy(x_vals, y_vals, x_label, y_label, x2_vals=None, y2_vals=None,
    ...
    plt.savefig('/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/loss_curve.png', format='png')    
    plt.show()
...
# train data path
train_xdir = '/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/Data/'
train_ypath = '/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/filelist.txt'
train_data_list = "/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/train.txt"

# test data path
test_xdir = '/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/Data/'
test_ypath = '/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/filelist.txt'
test_data_list= "/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/test.txt"
...
pre_label = open("/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/pre_label.txt", "w+")
model_label = open("/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/re_label.txt", "w+")
...
def train_ch5(train_iter, test_iter, batch_size, device, lr, w_d, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        PATH = '/media/mmlab/dataset/mengya/StentDetectionDataset/Dataset/D7/checkpoint/'
